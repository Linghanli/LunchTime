...
//    	showTime.setText(Integer.toString(elapsedTime) + " sec");
	...
	//			displayTryAgain();
			    mpTryAgain.start();	    
	//			encouragement.setText("Try Again!");	   
...
// or stay in current level				
		...
		public boolean checkCorrect(){
			...
			if(correct){
				return true;//Toast.makeText(getApplicationContext(),  "Good Job", Toast.LENGTH_SHORT).show();
			}
			else{
				return false;//Toast.makeText(getApplicationContext(),  "Try Again", Toast.LENGTH_SHORT).show();
			}
		}
}
